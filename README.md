...
*Note: The full Moon is about 1,800 arcseconds across.*
...
* **Uranus and Neptune** are calculated and tested, but I don't draw them in the normal sky view. They're too faint to be useful for a normal naked-eye observation. I would rather leave them out than put a label over empty-looking sky and make the app feel inaccurate.
* Objects that are technically above the horizon but aren't realistically visible because of daylight or a bright Moon are **dimmed** rather than silently disappearing.
